...
class WrapRequest {
     ...
     */
    pipe(transform) {
        const _a = this.options, { defaultData } = _a, restOptions = __rest(_a, ["defaultData"]);
        const wr = new WrapRequest(this.req, Object.assign(Object.assign({}, restOptions), { transform: transform }));
